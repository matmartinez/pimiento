...
function drawTextInRectWithAttributes(text, rect, attributes) {    
...
function RenderingContextTrampoline(context){    
  ...
  return {
    createRoundedRectPath: trampoline(roundRect),
    drawTextInRect: trampoline(drawTextInRectWithAttributes)
  }
}
